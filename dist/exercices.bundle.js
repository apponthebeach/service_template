...
module.exports = {
    ...
    addClass: function (el, className) {
        if (module.exports.os == "android") {
            if (className.startsWith("ww-") || className.startsWith("badge-default") || className.startsWith("icon-")) {
                var arr = className.split("__");
    ...
    removeClass: function (el, className) {
        if (el.classList) {
            ...
            if (module.exports.os == "android") {
                ...
                el.classList.remove(replacement);
            }
        }
        else {
            if (module.exports.os == "android") {
    ...
    convertEvent: function (event, fn, wwElement) {
        ...
        if (str.length > 1) {
            ...
            if (fnArgumentsWithComma.length > 0) {
                ...
                wwElement.addEventListener(event, function (el) {
...
var uiUtils = __webpack_require__(1);
var utils = __webpack_require__(0);

module.exports = {
    os: utils.getMobileOperatingSystem(),
    style: function (el) {
        if (uiUtils.hasClass(el, "ww-button")) {
            module.exports.styleDefault(el, "ww-button");
        } else if (uiUtils.hasClass(el, "ww-list")) {
            module.exports.styleList(el);
        } else if (uiUtils.hasClass(el, "ww-list-header")) {
            module.exports.styleListHeader(el);
        } else if (uiUtils.hasClass(el, "ww-list-item")) {
            module.exports.styleDefault(el, "ww-list-item");
            module.exports.styleListItem(el);
            var type = el.getAttribute("data-type");
            if (type) {
                switch (type) {
                    case "chevron":
                        module.exports.styleListItemChevron(el);
                        break;
                    case "checked":
                        module.exports.styleListItemChecked(el);
                        break;
                    default:
                        break;
                }
            ...
            if (value) {
                module.exports.styleListItemValue(el, value);
            }
        } else if (uiUtils.hasClass(el, "ww-input")) {
            module.exports.styleInput(el);
        } else {

        }
    },
    styleDefault: function (el, className) {
        uiUtils.addClass(el, "noselect");
        el.setAttribute(this.os, "");
    ...
    styleList: function (el) {
        el.setAttribute(this.os, "");
        for (var i = 0; i < el.children.length; i++) {
            if (i == 0 && !uiUtils.hasClass(el.children[i], "ww-list-header")) {
                el.style.borderTop = "1px solid #d2d2d2";
            }
            if (uiUtils.hasClass(el.children[i], "ww-list-header")) {
                el.children[i].style.borderBottom = "1px solid #d2d2d2";
            }
            if (i > 0 && !uiUtils.hasClass(el.children[i - 1], "ww-list-header")) {
                el.style.borderBottom = "1px solid #d2d2d2";
                var listSeparator = document.createElement("div");
                uiUtils.addClass(listSeparator, "ww-list-separator");
                listSeparator.setAttribute(this.os, "");
                el.insertBefore(listSeparator, el.children[i]);
                i++;
            }
        }
    },
    styleListHeader: function (el) {
        el.setAttribute(this.os, "");
    ...
    styleListItem: function (el) {
        ...
        rightContainer.style.minHeight = (el.offsetHeight - 28) + "px";
        rightContainer.style.alignItems = "center";
        rightContainer.style.width = "auto";
        rightContainer.style.overflow = "hidden";

        var dataBadge = el.getAttribute("data-badge");
        if (dataBadge) {
            var badge = document.createElement("div");
            switch (dataBadge) {
                case "default":
                    var dataBadgeValue = el.getAttribute("data-badge-value");
                    badge.innerHTML = dataBadgeValue;
                    uiUtils.addClass(badge, "badge-default");
                    break;
                case "red-circle":
                    uiUtils.addClass(badge, "badge-red-circle");
                    break;
                case "green-circle":
                    uiUtils.addClass(badge, "badge-green-circle");
                    break;
                case "yellow-circle":
                    uiUtils.addClass(badge, "badge-yellow-circle");
                    break;
            }
        ...
        var pH = span.parentNode.offsetHeight - 28;
        var spanMarginTop = pH / 2 - h / 2;
        span.style.marginTop = spanMarginTop + "px";
    },
    styleListItemChevron: function (el) {
        var rightContainer = el.querySelector("#right-container");
        ...
        if (this.os === "ios") {
            ...
            uiUtils.addClass(chevron, "icon-chevron");
            rightContainer.appendChild(chevron);
        }
    },
    styleListItemChecked: function (el) {
        var rightContainer = el.querySelector("#right-container");
        if (rightContainer == null) {
            rightContainer = document.createElement("div");
            rightContainer.id = "right-container";
        ...
        var chevron = document.createElement("div");
        uiUtils.addClass(chevron, "icon-check");
        rightContainer.appendChild(chevron);

        var span = el.querySelector("#span-text");
        var h = span.offsetHeight;
        var pH = span.parentNode.offsetHeight - 28;
        var spanMarginTop = pH / 2 - h / 2;
        span.style.marginTop = spanMarginTop + "px";
    },
    styleListItemValue: function (el, value) {
        var span = el.querySelector("#span-text");
        ...
        var dataValueColor = el.getAttribute("data-value-color");
        if (dataValueColor) {
            div.style.color = dataValueColor;
        }
        div.innerHTML = value;
        //document.body.appendChild(div);
        uiUtils.addClass(div, "value");
        rightContainer.insertBefore(div, rightContainer.firstChild);
    },
...
var localizedUtils = __webpack_require__(14);
...
var i18n = __webpack_require__(9);
...
var listHeader = __webpack_require__(18);
var input = __webpack_require__(19);
var searchInput = __webpack_require__(20);
var switchComponent = __webpack_require__(24);
var pagingIndicator = __webpack_require__(25);
var textArea = __webpack_require__(26);
var styler = __webpack_require__(2);
var utils = __webpack_require__(0);
var uiUtils = __webpack_require__(1);
...
function renderUI() {
    ...
    sharingCoachingButton.onClick(function(){
        //Partage avec email
        var data ='&companyName=LALALA&contactFirstname=AXEL&contactName=de%20Sainte%20Marie&contactEmail=axeldesaintemarie@gmail.com&contactSubject=WHAT%20A%20GREAT%20APP&contactMessage=THIS%20IS%20THE%20COOLEST%20APP%20IN%20THE%20WORLD';
        console.log(data);
        $.ajax({
	      type: "POST",
